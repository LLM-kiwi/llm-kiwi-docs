...
description: "Beginner-friendly explanations of core LLM.kiwi concepts: APIs, HTTP requests, chat messages, roles, models, tokens, context windows, and streaming."
icon: "lightbulb"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Explore models" href="/models">
    Choose the best model for your task.
  </Card>

  <Card title="Use a working example" href="/examples">
    Copy complete Python, JavaScript, and cURL examples.
  </Card>

  <Card title="Look up a term" href="/glossary">
