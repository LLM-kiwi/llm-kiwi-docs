...
description: "Glossary of LLM and API terms used in the LLM.kiwi docs, including tokens, prompts, completions, context windows, streaming, roles, and rate limits."
icon: "book"
---
...
<Card title="Learn these concepts in context" href="/concepts">
